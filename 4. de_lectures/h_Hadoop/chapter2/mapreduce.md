...
Hadoop이 `/home/ssafy/hadoop`에 설치되어 있다면
...
```bash
ls /home/ssafy/hadoop/share/hadoop/mapreduce/hadoop-mapreduce-client-app-*.jar
```
...
cd /home/ssafy/ssafy_hadoop/chapter2
...
```text
("Hello", 1), ("World", 1), ("Hello", 1), ("SSAFY", 1)
```
...
# 도커로 실행 시
docker cp /home/ssafy/h_Hadoop/chapter2/mapper.py namenode:mapper.py
docker cp /home/ssafy/h_Hadoop/chapter2/reducer.py namenode:reducer.py
