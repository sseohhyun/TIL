...
BUS_API_KEY = "79534461676b61743434566d464665"  # 서울시 버스 교통 데이터 API 키 (빈칸 채우기)
SUBWAY_API_KEY = "4478494c426b617439354e67644a73"  # 서울시 지하철 교통 데이터 API 키 (빈칸 채우기)
...
def integrate_data(bus_data, subway_data):
    ...
    return integrated_df[['교통수단', '날짜', '노선번호', '역/정류장명', '승차인원', '하차인원']]  # 최종적으로 '교통수단', '날짜', '노선번호', '역/정류장명', '승차인원', '하차인원' 컬럼만 포함한 데이터프레임 반환)
